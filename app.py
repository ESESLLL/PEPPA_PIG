...
.stApp { background: linear-gradient(135deg, #FFE5F1, #E5F1FF, #FFF5E5); }
...
div.stButton > button:active {
    ...
    box-shadow: 0 0 0 #FFB6D9 !important;
}
...
# ===== 可愛角色 SVG =====
def pig_svg(c="#FFB6C1"):
    return f'<svg width="58" height="58" viewBox="0 0 100 100" style="display:inline-block;margin:3px"><ellipse cx="50" cy="55" rx="38" ry="32" fill="{c}"/><ellipse cx="28" cy="32" rx="9" ry="12" fill="{c}"/><ellipse cx="72" cy="32" rx="9" ry="12" fill="{c}"/><ellipse cx="50" cy="68" rx="15" ry="12" fill="#FF8DAA"/><ellipse cx="44" cy="68" rx="3" ry="4" fill="#C25C7C"/><ellipse cx="56" cy="68" rx="3" ry="4" fill="#C25C7C"/><circle cx="38" cy="45" r="7" fill="#fff"/><circle cx="62" cy="45" r="7" fill="#fff"/><circle cx="39" cy="46" r="3.5" fill="#000"/><circle cx="61" cy="46" r="3.5" fill="#000"/><circle cx="40.5" cy="44.5" r="1.5" fill="#fff"/><circle cx="62.5" cy="44.5" r="1.5" fill="#fff"/><ellipse cx="32" cy="58" rx="6" ry="4" fill="#FFA0C0" opacity="0.6"/><ellipse cx="68" cy="58" rx="6" ry="4" fill="#FFA0C0" opacity="0.6"/><path d="M42 80 Q50 86 58 80" stroke="#C25C7C" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>'

def cat_svg():
    return '<svg width="58" height="58" viewBox="0 0 100 100" style="display:inline-block;margin:3px"><polygon points="25,28 38,52 14,50" fill="#FFA64D"/><polygon points="75,28 62,52 86,50" fill="#FFA64D"/><circle cx="50" cy="58" r="33" fill="#FFB870"/><circle cx="40" cy="52" r="7" fill="#fff"/><circle cx="60" cy="52" r="7" fill="#fff"/><circle cx="40" cy="53" r="3.5" fill="#000"/><circle cx="60" cy="53" r="3.5" fill="#000"/><polygon points="50,60 45,65 55,65" fill="#FF6B6B"/><line x1="18" y1="58" x2="36" y2="60" stroke="#888" stroke-width="1.5"/><line x1="64" y1="60" x2="82" y2="58" stroke="#888" stroke-width="1.5"/></svg>'

def rabbit_svg():
    return '<svg width="58" height="58" viewBox="0 0 100 100" style="display:inline-block;margin:3px"><ellipse cx="40" cy="22" rx="8" ry="20" fill="#fff" stroke="#EEE"/><ellipse cx="60" cy="22" rx="8" ry="20" fill="#fff" stroke="#EEE"/><ellipse cx="40" cy="24" rx="4" ry="14" fill="#FFD1DC"/><ellipse cx="60" cy="24" rx="4" ry="14" fill="#FFD1DC"/><circle cx="50" cy="60" r="31" fill="#fff" stroke="#EEE"/><circle cx="40" cy="55" r="6" fill="#000"/><circle cx="60" cy="55" r="6" fill="#000"/><ellipse cx="50" cy="64" rx="4" ry="3" fill="#FF8DAA"/><ellipse cx="33" cy="63" rx="5" ry="4" fill="#FFD1DC" opacity="0.7"/><ellipse cx="67" cy="63" rx="5" ry="4" fill="#FFD1DC" opacity="0.7"/></svg>'

def dog_svg():
    return '<svg width="58" height="58" viewBox="0 0 100 100" style="display:inline-block;margin:3px"><ellipse cx="24" cy="42" rx="11" ry="22" fill="#B5835A"/><ellipse cx="76" cy="42" rx="11" ry="22" fill="#B5835A"/><circle cx="50" cy="58" r="33" fill="#E0C097"/><circle cx="40" cy="52" r="7" fill="#fff"/><circle cx="60" cy="52" r="7" fill="#fff"/><circle cx="40" cy="53" r="3.5" fill="#000"/><circle cx="60" cy="53" r="3.5" fill="#000"/><ellipse cx="50" cy="64" rx="6" ry="5" fill="#000"/></svg>'

def bear_svg():
    return '<svg width="58" height="58" viewBox="0 0 100 100" style="display:inline-block;margin:3px"><circle cx="28" cy="30" r="13" fill="#C89B6E"/><circle cx="72" cy="30" r="13" fill="#C89B6E"/><circle cx="28" cy="30" r="7" fill="#E5C9A5"/><circle cx="72" cy="30" r="7" fill="#E5C9A5"/><circle cx="50" cy="58" r="33" fill="#C89B6E"/><circle cx="40" cy="52" r="6" fill="#000"/><circle cx="60" cy="52" r="6" fill="#000"/><circle cx="50" cy="64" r="9" fill="#E5C9A5"/><ellipse cx="50" cy="61" rx="5" ry="4" fill="#000"/></svg>'

def frog_svg():
    return '<svg width="58" height="58" viewBox="0 0 100 100" style="display:inline-block;margin:3px"><ellipse cx="50" cy="62" rx="36" ry="30" fill="#7AC74F"/><circle cx="32" cy="32" r="15" fill="#7AC74F"/><circle cx="68" cy="32" r="15" fill="#7AC74F"/><circle cx="32" cy="30" r="9" fill="#fff"/><circle cx="68" cy="30" r="9" fill="#fff"/><circle cx="32" cy="31" r="4.5" fill="#000"/><circle cx="68" cy="31" r="4.5" fill="#000"/><path d="M35 65 Q50 78 65 65" stroke="#3D8B27" stroke-width="3" fill="none" stroke-linecap="round"/></svg>'

CHARACTERS = {
    "🐷 粉紅豬": pig_svg("#FFB6C1"), "🐷 紫色豬": pig_svg("#D8B5E8"),
    "🐷 黃色豬": pig_svg("#FFE5A0"), "🐱 小貓咪": cat_svg(),
    "🐰 小白兔": rabbit_svg(), "🐶 小狗狗": dog_svg(),
    "🐻 小熊熊": bear_svg(), "🐸 小青蛙": frog_svg(),
}

# ===== 音效 (iPad 相容版：solidify autoplay) =====
def play_sound(kind):
    if kind == "correct":
        ...
        try {{
            ...
            notes.forEach((f,i) => {{
                ...
                g.gain.exponentialRampToValueAtTime(0.001, c.currentTime + i*0.12 + 0.15);
...
# ===== 初始化 =====
for k, v in [("score",0),("stars",0),("question",None),("answered",False),("result",None)]:
...
with st.sidebar:
    st.header("⚙️ 遊戲設定")
    level = st.selectbox("選擇難度",
        ["超簡單 (+1)", "簡單 (1-5)", "中等 (1-10)", "困難 (1-20)"])
    st.markdown("---")
...
st.markdown(
    f"<h1 style='text-align:center; color:#FF2D7E; font-size:50px'><span class='bounce'>{q['a']} {q['op']} {q['b']} = ❓</span></h1>",
    unsafe_allow_html=True
)
