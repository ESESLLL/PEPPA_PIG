...
def pig_svg(color="#FFB6C1"):
    ...
    <svg width="80" height="80" viewBox="0 0 100 100">
      <ellipse cx="50" cy="55" rx="38" ry="32" fill="{color}"/>
      <ellipse cx="50" cy="68" rx="14" ry="11" fill="#FF8DAA"/>
      <circle cx="44" cy="68" r="3" fill="#8B4B62"/>
      <circle cx="56" cy="68" r="3" fill="#8B4B62"/>
      <circle cx="38" cy="45" r="5" fill="#fff"/>
      <circle cx="62" cy="45" r="5" fill="#fff"/>
      <circle cx="39" cy="46" r="2.5" fill="#000"/>
      <circle cx="61" cy="46" r="2.5" fill="#000"/>
      <ellipse cx="28" cy="32" rx="8" ry="11" fill="{color}"/>
      <ellipse cx="72" cy="32" rx="8" ry="11" fill="{color}"/>
      <path d="M40 78 Q50 85 60 78" stroke="#8B4B62" stroke-width="2" fill="none"/>
    </svg>
    """
...
def cat_svg():
    return """
    <svg width="80" height="80" viewBox="0 0 100 100">
      <polygon points="25,30 35,55 15,55" fill="#FFA64D"/>
      <polygon points="75,30 85,55 65,55" fill="#FFA64D"/>
      <circle cx="50" cy="58" r="32" fill="#FFB870"/>
      <circle cx="40" cy="52" r="5" fill="#fff"/>
      <circle cx="60" cy="52" r="5" fill="#fff"/>
      <circle cx="40" cy="53" r="2.5" fill="#000"/>
      <circle cx="60" cy="53" r="2.5" fill="#000"/>
      <polygon points="50,60 46,65 54,65" fill="#FF6B6B"/>
      <line x1="20" y1="62" x2="38" y2="62" stroke="#000" stroke-width="1.5"/>
      <line x1="62" y1="62" x2="80" y2="62" stroke="#000" stroke-width="1.5"/>
    </svg>
    """
...
def rabbit_svg():
    return """
    <svg width="80" height="80" viewBox="0 0 100 100">
      <ellipse cx="40" cy="25" rx="8" ry="20" fill="#fff" stroke="#ddd"/>
      <ellipse cx="60" cy="25" rx="8" ry="20" fill="#fff" stroke="#ddd"/>
      <ellipse cx="40" cy="25" rx="4" ry="14" fill="#FFD1DC"/>
      <ellipse cx="60" cy="25" rx="4" ry="14" fill="#FFD1DC"/>
      <circle cx="50" cy="60" r="30" fill="#fff" stroke="#ddd"/>
      <circle cx="40" cy="55" r="4" fill="#000"/>
      <circle cx="60" cy="55" r="4" fill="#000"/>
      <ellipse cx="50" cy="65" rx="4" ry="3" fill="#FF6B6B"/>
    </svg>
    """
...
# ===== 音效 (用 base64 內嵌，免外部檔案) =====
def play_sound(kind):
    # 用 Web Audio API 產生簡單音效
    if kind == "correct":
        js = """
        <script>
...
def show_chars(n):
    return "<div style='text-align:center'>" + (svg * n) + "</div>"
